...
def run(modes, n_folds, stage):
  ...
  xsec_tot_bkg = eff["ZZ"]*xsec["ZZ"] + eff["WWee"]*xsec["WWee"] + eff["Zll"]*xsec["Zll"] + eff["eeZ"]*xsec["eeZ"] + eff["gaga_ee"]*xsec["gaga_ee"]
  for cur_mode in modes:
...
if __name__ == '__main__':
  ...
  parser.add_argument("--Mode", action = "store", dest = "modes", default = ["eeH","ZZ","WWee","Zll","eeZ","gaga_ee"], help="Decay cur_mode")
