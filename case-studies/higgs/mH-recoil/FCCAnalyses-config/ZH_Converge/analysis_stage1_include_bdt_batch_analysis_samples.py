...
processList = {
    ...
    'p8_ee_WW_mumu_ecm240':{'chunks':20},
...
outputDirEos= "/eos/user/l/lia/FCCee/ZH_Converge/BDT_analysis_samples/"
eosType = "eosuser"
...
userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/ZH_Converge/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/mumu/userBatch.Config"
#USER DEFINED CODE
import ROOT
ROOT.gInterpreter.ProcessLine('''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "/eos/user/l/lia/FCCee/ZH_Converge/BDT/xgb_bdt.root");
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            #.Define("leps_sel_iso", "HiggsTools::sel_isol(99)(leps_all, leps_all_iso)")
