...
userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/NewWorkFlow/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/ZH/userBatch.Config"
#USER DEFINED CODE
import ROOT
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            #.Define("leps_sel_iso", "FCCAnalyses::sel_iso(99)(leps_all, leps_all_iso)")
