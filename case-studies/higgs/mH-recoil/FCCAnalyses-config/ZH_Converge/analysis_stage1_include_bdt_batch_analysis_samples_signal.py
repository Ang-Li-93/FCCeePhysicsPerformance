...
outputDirEos= "/eos/user/l/lia/FCCee/NewWorkFlow/BDT_analysis_samples/"
eosType = "eosuser"
...
userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/NewWorkFlow/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/mumu/userBatch.Config"
#USER DEFINED CODE
import ROOT
...
class RDFanalysis():
    ...
    def output():
        branchList = [
            ...
            #number of leptons
            "leps_no",
            #Higgs decay informations truth level
