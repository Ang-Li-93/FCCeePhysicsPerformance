...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/l/lia/FCCee/ZH_Converge/BDT_analysis_samples/final/'
#formats        = ['png','pdf']
yaxis          = ['lin','log']
#yaxis          = ['lin']
...
formats        = ['pdf']
#yaxis          = ['lin']
outdir         = '/eos/user/l/lia/FCCee/ZH_Converge/BDT_analysis_samples/plots_rare/'
