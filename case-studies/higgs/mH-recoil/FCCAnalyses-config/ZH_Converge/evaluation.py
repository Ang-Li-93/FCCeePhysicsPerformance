...
def run():
    ...
    print(f"------>Saving {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_logloss.pdf")
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_logloss.pdf")
    ...
    print(f"------>Saving {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_error.pdf")
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_error.pdf")
    ...
    print(f"------>Saving {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_auc.pdf")
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_auc.pdf")
    ...
    ax.set_title('ROC')
    ax.legend()
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_ROC1.pdf")
    print(f"------>Saved {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_ROC1.pdf")
    ...
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_SB.pdf")
    print(f"------>Saved {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_SB.pdf")
    ...
    plt.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_Importance.pdf")
    print(f"------>Saved {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_Importance.pdf")
    ...
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_Significance_Z_scan.pdf")
    print(f"------>Saved {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_Significance_Z_scan.pdf")  
    ...
    plt.tight_layout()
    fig.savefig(f"{loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_BDT_eff_nolog.pdf")
    print(f"------>Saved {loc.PLOTS}/mumuH_vs_ZZ_WWmumu_Zll_eeZ_BDT_eff_nolog.pdf") 
