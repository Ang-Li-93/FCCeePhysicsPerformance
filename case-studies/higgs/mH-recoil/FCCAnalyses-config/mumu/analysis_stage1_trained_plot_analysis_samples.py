...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/l/lia/FCCee/MVA_Final/trainedNtuples_analysis_samples/final/'
#formats        = ['png','pdf']
yaxis          = ['lin','log']
#yaxis          = ['lin']
...
formats        = ['pdf']
#yaxis          = ['lin']
outdir         = '/eos/user/l/lia/FCCee/MVA_Final/trainedNtuples_analysis_samples/plots/'
