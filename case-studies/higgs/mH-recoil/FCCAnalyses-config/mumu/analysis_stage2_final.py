...
cutList = {#"sel0":"return true;",
            ...
            "sel_APC3":"zed_leptonic_m.size()==1 &&  zed_leptonic_m[0]> 73 && zed_leptonic_m[0]  < 120 && zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5",
            "sel_APC3_MVA03":"MVAScore0>0.3 &&   zed_leptonic_m.size()==1 &&  zed_leptonic_m[0]> 73 && zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5",
            "sel_APC3_MVA04":"MVAScore0>0.4 &&   zed_leptonic_m.size()==1 &&  zed_leptonic_m[0]> 73 && zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5",
            "sel_APC3_MVA05":"MVAScore0>0.5 &&   zed_leptonic_m.size()==1 &&  zed_leptonic_m[0]> 73 && zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5",
            "sel_APC3_costhetamiss":"zed_leptonic_m.size()==1 && zed_leptonic_m[0]  > 73 &&  zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5&& cosTheta_miss.size() ==1 && cosTheta_miss[0]  > -0.98 && cosTheta_miss[0]  < 0.98",
            "sel_APC3_MVA02_costhetamiss":"MVAScore0>0.2 && zed_leptonic_m.size()==1 && zed_leptonic_m[0]  > 73 &&  zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5&& cosTheta_miss.size() ==1 && cosTheta_miss[0]  > -0.98 && cosTheta_miss[0]  < 0.98",
            "sel_APC3_MVA03_costhetamiss":"MVAScore0>0.3 && zed_leptonic_m.size()==1 && zed_leptonic_m[0]  > 73 &&  zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5&& cosTheta_miss.size() ==1 && cosTheta_miss[0]  > -0.98 && cosTheta_miss[0]  < 0.98",
            "sel_APC3_MVA04_costhetamiss":"MVAScore0>0.4 && zed_leptonic_m.size()==1 && zed_leptonic_m[0]  > 73 &&  zed_leptonic_m[0]  < 120 &&zed_leptonic_recoil_m.size()==1 && zed_leptonic_recoil_m[0]  > 120 &&zed_leptonic_recoil_m[0]  <140 && zed_leptonic_pt[0]  > 5&& cosTheta_miss.size() ==1 && cosTheta_miss[0]  > -0.98 && cosTheta_miss[0]  < 0.98",
            }
